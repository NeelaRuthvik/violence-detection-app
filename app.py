...
MODEL_PATH_MAP = {
    "MobileNet_BiLSTM_Attention (95.5%)": os.path.join(BASE_DIR, "models/mobilenet_bilstm_attention (1).h5"),
    "CNN_LSTM_Attention (88%)": os.path.join(BASE_DIR, "models/cnn_lstm_attention (1).h5"),
}
